...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/mini_simulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_simulation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_simulation/environment/path.sh"
